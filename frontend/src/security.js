...
const SecurityCheck = () => {
    ...
    return (
        <div className="flex flex-col items-center justify-center min-h-screen bg-gradient-to-br from-indigo-100 via-purple-100 to-pink-100 p-6 overflow-hidden">
            ...
            <div className="z-10 bg-white bg-opacity-90 rounded-3xl p-8 shadow-xl backdrop-blur-sm max-w-2xl w-full">
                <h1 className="text-4xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-purple-600 to-pink-600 mb-8 text-center">
                ...
                <div className="relative w-80 h-80 mb-8 mx-auto">
                    ...
                    <Shield
                        size={320}
                        className={`absolute inset-0 transition-all duration-1000 ease-in-out ${getColor()} stroke-current`}
                        strokeWidth={1.5}
                    />
                ...
                <div className="text-xl font-semibold text-purple-700 mb-4 text-center">
                    {progress < 100 ? 'Zenara Protection Calibrating...' : 'Zenara Protection Activated!'}
                </div>

                <div className="flex items-center justify-center text-lg text-gray-700 mb-8 bg-gradient-to-r from-purple-100 to-pink-100 rounded-full px-6 py-3">
